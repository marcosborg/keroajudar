...
return [
    ...
    'beneficiaryManagement' => [
        'title'          => 'Beneficiários',
        'title_singular' => 'Beneficiários',
    ],
    'beneficiaryCategory' => [
        'title'          => 'Categorias de beneficiários',
        'title_singular' => 'Categoria de beneficiários',
        'fields'         => [
            'id'                => 'ID',
            'id_helper'         => ' ',
            'name'              => 'Nome',
            'name_helper'       => ' ',
            'description'       => 'Descrição',
            'description_helper'=> 'Texto breve sobre a categoria',
            'image'             => 'Imagem de fundo',
            'image_helper'      => 'Imagem para os blocos da landing',
            'created_at'        => 'Created at',
            'created_at_helper' => ' ',
            'updated_at'        => 'Updated at',
            'updated_at_helper' => ' ',
        ...
        'fields'         => [
            'id'                   => 'ID',
            'id_helper'            => ' ',
            'beneficiary_category' => 'Categoria',
            ...
            'vat_number'           => 'NIF/NIPC',
            'vat_number_helper'    => ' ',
            'commercial_certificate_code' => 'Código da certidão comercial',
            'commercial_certificate_code_helper' => 'Formato: 0000-0000-0000',
            'iban'                 => 'IBAN',
            'iban_helper'          => 'Ex: PT50... (sem espaços)',
            ...
            'postal_code'          => 'Código postal',
            'postal_code_helper'   => 'Formato: 0000-000',
            'default_commission_percent' => 'Comissão normal (%)',
            'default_commission_percent_helper' => 'Percentagem aplicada quando não há passatempo ativo. Pode ser 0%.',
            'city'                 => 'Cidade',
            'city_helper'          => ' ',
            'country'              => 'Pais',
            'country_helper'       => ' ',
    ...
    'raffleGame' => [
        ...
        'fields'         => [
            ...
            'description'       => 'Descricao',
            'description_helper'=> ' ',
            'commission_percent' => 'Comissão do passatempo (%)',
            'commission_percent_helper' => 'Percentagem aplicada quando este passatempo está ativo. Pode ser 0%.',
            'created_at'        => 'Created at',
            'created_at_helper' => ' ',
            'updated_at'        => 'Updated at',
            'updated_at_helper' => ' ',
