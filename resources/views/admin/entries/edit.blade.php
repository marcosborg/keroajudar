...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.entry.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.entries.update", [$entry->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="raffle_code">{{ trans('cruds.entry.fields.raffle_code') }}</label>
                <input class="form-control {{ $errors->has('raffle_code') ? 'is-invalid' : '' }}" type="text" name="raffle_code" id="raffle_code" value="{{ old('raffle_code', $entry->raffle_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $entry->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $entry->first_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $entry->last_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $entry->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $entry->amount) }}" step="0.01" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_company') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_company" id="is_company" value="1" {{ $entry->is_company || old('is_company', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nif') ? 'is-invalid' : '' }}" type="text" name="nif" id="nif" value="{{ old('nif', $entry->nif) }}">
                @if($errors->has('nif'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nif') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nipc') ? 'is-invalid' : '' }}" type="text" name="nipc" id="nipc" value="{{ old('nipc', $entry->nipc) }}">
                @if($errors->has('nipc'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nipc') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $entry->address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal_code') ? 'is-invalid' : '' }}" type="text" name="postal_code" id="postal_code" value="{{ old('postal_code', $entry->postal_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $entry->city) }}" required>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country_id" id="country_id" required>
                    @foreach($countries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $entry->country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('consent_privacy') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="consent_privacy" id="consent_privacy" value="1" {{ $entry->consent_privacy || old('consent_privacy', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Entry::CONTACT_VIA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('contact_via') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="contact_via_{{ $key }}" name="contact_via" value="{{ $key }}" {{ old('contact_via', $entry->contact_via) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source_page') ? 'is-invalid' : '' }}" type="text" name="source_page" id="source_page" value="{{ old('source_page', $entry->source_page) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('client_ip') ? 'is-invalid' : '' }}" type="text" name="client_ip" id="client_ip" value="{{ old('client_ip', $entry->client_ip) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_agent') ? 'is-invalid' : '' }}" type="text" name="user_agent" id="user_agent" value="{{ old('user_agent', $entry->user_agent) }}">
