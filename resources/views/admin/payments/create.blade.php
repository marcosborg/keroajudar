    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Payment::METHOD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('method') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="method_{{ $key }}" name="method" value="{{ $key }}" {{ old('method', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('cancelled_at') ? 'is-invalid' : '' }}" type="text" name="cancelled_at" id="cancelled_at" value="{{ old('cancelled_at') }}">
