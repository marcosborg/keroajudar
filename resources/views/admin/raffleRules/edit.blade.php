...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.raffleRule.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.raffle-rules.update", [$raffleRule->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numbers') ? 'is-invalid' : '' }}" type="number" name="numbers" id="numbers" value="{{ old('numbers', $raffleRule->numbers) }}" step="1" min="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ old('active', $raffleRule->active) == 1 ? 'checked' : '' }}>
