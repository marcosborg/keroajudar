    ...
    @if(isset($beneficiarySelected) && $beneficiarySelected)
      ...
      <div class="card shadow-sm border-0 mb-4">
        <div class="row g-0 align-items-center">
          ...
          <div class="col-lg-7">
            <div class="p-4">
              <p class="text-uppercase text-success fw-semibold mb-1">{{ $beneficiarySelected->category->name ?? 'Beneficiário' }}</p>
              <h2 class="mb-2">{{ $beneficiarySelected->name }}</h2>
              @if($beneficiarySelected->description)
                <p class="text-muted">{{ Str::limit($beneficiarySelected->description, 200) }}</p>
              @endif
      ...
      <div class="col-lg-8">
        <div class="form-shell">
          ...
          <p class="text-muted mb-4">
            Complete os dados para apoiar este beneficiário.
          </p>

          <div id="donationFormWrapper">
            <form id="donationForm" novalidate>
              <input type="hidden" name="category_id" id="category_id" value="{{ $beneficiarySelected->beneficiary_category_id }}">
              <input type="hidden" name="beneficiary_id" id="beneficiary_id" value="{{ $beneficiarySelected->id }}">
              <!-- Valor -->
...
<script>
  (function(){
    ...
    // Preenchimento de dias/meses/anos
